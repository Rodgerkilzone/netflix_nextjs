...
<div style={{padding:20,width:'100%',textAlign:'center'}}> <h2 style={{ color: 'white', margin: 10 }}>Movie list</h2>
     </div>
      <div
        style={{
          margin: 10,
    ...
    <div className='UserProfile'>
      <div className='User'>
        <div
          ...
          style={{ color: 'white',background:"#D32F2F",padding:10,borderRadius:4 }}
        >
          Upload Movie
        </div>
